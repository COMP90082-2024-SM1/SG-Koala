"""
Django settings for Koala_backend project.
...
SECRET_KEY = 'django-insecure-a@s60(vh$-%k(i8=!_d#ll#a-@6j005y=#+w6ts4w_bgqq^9eu'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['.vercel.app',"localhost","localhost","127.0.0.1"]
...
WSGI_APPLICATION = 'Koala_backend.wsgi.application'
