...
import { getAllTemplates,getAllMiscellaneous,getAllSchool,createNewBooking,createNewSchool,createNewChecklist } from '../api/NewbookingAPI';
      ...
      {activeCategory === "Delivery" && (
        <form className="newBookingForm">
          ...
          <select
            ...
            onChange={(e) => handleChange('Delivery', 'streamSelect', e.target.value)}
          >
            <option value="" >Please select a stream</option>
            {data.Delivery.programStreams && data.Delivery.programStreams.map((stream, index) => (
          ...
          <label>Template:</label>
            <select
              ...
              onChange={(e) => handleChange('Delivery', 'templateSelect', e.target.value)}
            >
              <option value="" disabled>Please select a template</option>
              {data.Delivery.templates && data.Delivery.templates.map((template, index) => (
          ...
          <select
            ...
            onChange={(e) => handleChange('Delivery', 'facilitatorsSelect', e.target.value)}
          >
            <option value="" >Please select facilitators</option>
            {data.Delivery.facilitators && data.Delivery.facilitators.map((facilitator, index) => (
              <option key={index} value={facilitator}>{facilitator}</option>
            ))}
          </select>
          ...
          <select
            ...
            onChange={(e) => handleChange('Delivery', 'locationSelect', e.target.value)}
          >
            <option value="" >Please select a location</option>
            {data.Delivery.location && data.Delivery.location.map((location, index) => (
          ...
          <input
            ...
            onChange={(e) => handleChange('Delivery', 'programDate', e.target.value)}
          />
          ...
          {["Module 1", "Module 2", "Module 3"].map((label, index) => (
            <React.Fragment key={label}>
              ...
              <select
                ...
                onChange={(e) => handleMultiSelectChange('Delivery', 'moduleSelects', index, e.target.value)}
              >
                <option value="" >Please select a module</option>
                {data.Delivery.module && data.Delivery.module.map((module, modIndex) => (
                  <option key={modIndex} value={module}>{module}</option>
                ))}
              </select>
            </React.Fragment>
          ))}
          ...
          <select
            ...
            onChange={(e) => handleChange('Delivery', 'exhibitionSelect', e.target.value)}
          >
            <option value="" >Please select an exhibition</option>
            {data.Delivery.exhibition && data.Delivery.exhibition.map((exhibition, index) => (
              <option key={index} value={exhibition}>{exhibition}</option>
            ))}
          </select>
        ...
        <form className="newBookingForm">
          ...
          <select
            ...
            onChange={(e) => {
              ...
              const selectedSchool = data.School.schools.find(school => school.id === selectedSchoolId);
              handleChange('School', 'schoolSelect', selectedSchoolId);
              handleChangeNested('School', 'school', 'id', selectedSchoolId);
              handleChangeNested('School', 'school', 'name', selectedSchool?.name);
            }}
          >
            <option value="" disabled>Please select a school</option>
          ...
          <input
            ...
            onChange={(e) => handleChange('School', 'registeredStudents', e.target.value)}
          />
          ...
          <fieldset>
            ...
            <input
              ...
              onChange={(e) => handleChangeNested('School', 'contactInfo', 'firstName', e.target.value)}
            />
            ...
            <input
              ...
              onChange={(e) => handleChangeNested('School', 'contactInfo','lastName', e.target.value)}
            />
            <label>Email Address:</label>
            <input
              type="email"
              value={data.School.contactInfo.email}
              onChange={(e) => handleChangeNested('School', 'contactInfo','email', e.target.value)}
            />
            <label>Phone Number:</label>
            <input
              type="tel"
              value={data.School.contactInfo.phoneNumber}
              onChange={(e) => handleChangeNested('School', 'contactInfo','phoneNumber', e.target.value)}
            />
            <label>Teaching Area/Job Title:</label>
            <input
              type="text"
              value={data.School.contactInfo.jobTitle}
              onChange={(e) => handleChangeNested('School', 'contactInfo','jobTitle', e.target.value)}
            />
          </fieldset>
          ...
          <textarea
            ...
            onChange={(e) => handleChange('School', 'additionalComments', e.target.value)}
          />

          <label>Accessibility Needs Communicated:</label>
          <select
            value={data.School.accessibilityNeeds}
            onChange={(e) => handleChange('School', 'accessibilityNeeds', e.target.value)}
          >
            <option value="" disabled>Yes or No</option>
            <option value="Y">Yes</option>
            <option value="N">No</option>
          ...
          <select
            ...
            onChange={(e) => handleChange('School', 'allergenInfo', e.target.value)}
          >
            <option value="" disabled>Yes or No</option>
            <option value="Y">Yes</option>
            <option value="N">No</option>
          ...
          <select
            ...
            onChange={(e) => handleChange('School', 'isPartnerSchool', e.target.value)}
          >
            <option value="" disabled>Yes or No</option>
            <option value="Y">Yes</option>
            <option value="N">No</option>
        ...
        <form className="newBookingForm">
          ...
          <div className="checkbox-container">
            <input
              ...
              onChange={(e) => handleChange('Bus', 'savedReceipt', e.target.checked ? "Y" : "N")}
            />
          ...
          <div className="checkbox-container">
            <input
              ...
              onChange={(e) => handleChange('Bus', 'enterIntoExpenseMaster', e.target.checked ? "Y" : "N")}
            />
          ...
          <div className="checkbox-container">
            <input
              ...
              onChange={(e) => handleChange('Bus', 'pinCategoriseEmail', e.target.checked ? "Y" : "N")}
            />
      ...
      {activeCategory === "Others" && (
        <form className="newBookingForm">
          ...
          <input
            ...
            onChange={(e) => handleChange('Others', 'perStudent', e.target.value)}
          />
          ...
          <input
            ...
            onChange={(e) => handleChange('Others', 'expenses', e.target.value)}
          />
